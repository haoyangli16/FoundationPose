...
This is the forked implementation of FoundationPose, the offical implementation could be found [here](https://github.com/NVlabs/FoundationPose)
...
If it's the first time you launch the container, you need to build extensions. Run this command _inside_ the Docker container.
